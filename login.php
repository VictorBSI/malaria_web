...
echo '<img src="logo.png" height="50px" width="75px" style="display: block; margin-left: auto; margin-right: auto;">';
echo '</div>';
echo '<div class="card-header">';
echo '<h4 style="text-align: center;">Login</h4>';
echo '</div>';
...
echo '</div>';
echo '<div class="form-group mb-3">';
echo '<button type="submit" name="login_now_btn" class="btn btn-success" style="display: block; margin-left: auto; margin-right: auto;">Login</button>';
echo '</div>';
echo '</form>';
echo '</div>';
echo '</div>';
